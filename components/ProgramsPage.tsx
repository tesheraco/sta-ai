...
const PILLAR_STYLES: Record<ProgramPillar, { badge: string; chip: string }> = {
    [ProgramPillar.STEM]: { badge: 'bg-sta-primary text-white', chip: 'bg-sta-primary text-white' },
    [ProgramPillar.AI]: { badge: 'bg-sta-secondary text-white', chip: 'bg-sta-secondary text-white' },
    [ProgramPillar.ESPORTS]: { badge: 'bg-sta-accent text-black', chip: 'bg-sta-accent text-black' },
};
                            ...
                            {filteredPrograms.map(program => (
                                ...
                                >
                                    <div className="h-44 overflow-hidden border-b-2 border-black relative">
                                        ...
                                        />
                                        <div className={`absolute top-4 left-4 px-3 py-1 rounded-full border-2 border-black text-xs font-black uppercase tracking-wider shadow-sm ${PILLAR_STYLES[program.pillar].badge}`}>
                                            {program.pillar}
                                        </div>
                                        <div className="absolute top-4 right-4 bg-white px-3 py-1 rounded-full border-2 border-black text-xs font-black shadow-sm flex items-center gap-1">
                                            <GraduationCap className="w-3.5 h-3.5" /> {program.grades.replace('Grades ', '')}
                                        </div>
                                    </div>
