...
export const PROGRAMS: Program[] = [
    // Array order is display order in the Program Library.
    {
        id: 'launch-esports',
        ...
        curriculumArc: [
            ...
            { weeks: 'Weeks 15–16', title: 'The Championship', description: 'A bracketed in-house tournament with families in the stands, with casters, scoreboard, and awards included.', isCapstone: true }
        ],
        staffOutcomes: [
        ...
        caseStudyId: 'newark-board-of-education'
    },
    {
        id: 'robocubes',
        title: 'RoboCubes',
    ...
    {
        id: 'lab-coat-science',
        title: 'Lab Coat Science',
        pillar: ProgramPillar.STEM,
        grades: 'Grades K–5',
        gradeBands: ['K–2', '3–5'],
        description: 'Hands on experiments that fizz, bubble, and launch. Students put on goggles, make predictions, and run real tests with everyday materials.',
        devices: 'None',
        materials: 'Grocery store supplies (baking soda, vinegar, cornstarch, food coloring, balloons, red cabbage), safety goggles, and a reusable lab kit bin',
        image: '/programs/lab-coat-science.jpg',
        imageCredit: { text: 'dwc.internal', license: 'CC BY-SA 2.0', url: 'https://commons.wikimedia.org/wiki/File:Outreach_with_girls.jpg' },
        tags: ['Science', 'Experiments', 'Screen-Free'],
        screenFree: true,
        studentOutcomes: [
            'Follow lab safety rules and wear goggles like real scientists',
            'Make a prediction, run a fair test, and record what actually happened',
            'Explore chemical reactions: fizzing, color changes, and slime that acts like a solid and a liquid',
            'Launch balloon rockets and catapults to see forces and motion in action',
            'Design and run their own "what if" experiment',
            'Present a live demo at a family Science Night'
        ],
        whyItMatters: [
            { title: 'The scientific method, made physical', description: 'Predict, test, observe, repeat. Students practice the whole cycle every session instead of reading about it.' },
            { title: 'Science that school days squeeze out', description: 'Elementary schedules often lose science time to reading and math. Afterschool is where kids get to do the experiments.' },
            { title: 'Everyday materials, big reactions', description: 'Nearly everything comes from the grocery store, so kids go home knowing they can try the experiment again in their own kitchen.' },
            { title: 'The pickup wow factor', description: 'Kids leave talking about the thing that fizzed over or launched across the room. Parents hear about it before they reach the car.' }
        ],
        curriculumArc: [
            { weeks: 'Weeks 1–3', title: 'Lab Safety & Observation', description: 'Goggles on, lab rules, and careful looking. Students run their first fizz test and record results in a lab notebook.' },
            { weeks: 'Weeks 4–7', title: 'Kitchen Chemistry', description: 'Reactions, slime, and a red cabbage indicator that changes color. Every experiment starts with a prediction.' },
            { weeks: 'Weeks 8–10', title: 'Forces & Motion', description: 'Balloon rockets, catapults, and ramps. Students measure distance and change one variable at a time.' },
            { weeks: 'Weeks 11–14', title: 'Mini Scientists', description: 'Students pick a question, design a fair test, and run it. Younger groups test together, older groups work in pairs.' },
            { weeks: 'Weeks 15–16', title: 'Science Night', description: 'Families visit demo stations where students run their favorite experiments live and explain what\'s happening.', isCapstone: true }
        ],
        staffOutcomes: [
            'Run safe, well organized experiments with no science background required',
            'Prep and store supplies so setup and cleanup fit inside the session',
            'Coach predictions and fair tests with simple questions kids can answer',
            'Host a Science Night that puts students in charge of the demos'
        ],
        trainingModules: [
            { title: 'Module 1: Lab Bootcamp', description: 'Run the signature experiments yourself during training, from the first fizz test to slime.' },
            { title: 'Module 2: Safety & Setup', description: 'Goggles, spill plans, table layouts, and the ten minute cleanup routine.' },
            { title: 'Module 3: Asking Like a Scientist', description: 'The questions that turn a cool reaction into a prediction, a test, and a conclusion.' },
            { title: 'Module 4: Scaling by Age', description: 'How each experiment runs with kindergartners versus 5th graders, from guided demos to student designed tests.' },
            { title: 'Module 5: Science Night', description: 'The event playbook: demo stations, student roles, and keeping a room full of families safe and dry.' }
        ],
        // TODO(verify): confirm these four numbers before publishing widely
        logistics: {
        ...
        faq: [
            { question: 'How messy is it?', answer: 'Some sessions are, on purpose. Every session guide includes table covers, a spill plan, and a cleanup routine built into the time, so the room is reset before pickup.' },
            { question: 'Are the materials safe for K–2?', answer: 'Yes. The curriculum uses kitchen and grocery store materials only, with no hazardous chemicals. Goggles are required for every experiment, and the youngest groups do the messiest steps as guided demos.' }
        ]
    },
    {
        ...
        imageCredit: { text: 'Davegriffin242', license: 'CC BY 4.0', url: 'https://commons.wikimedia.org/wiki/File:Success!.jpg' },
        ...
        caseStudyId: 'phipps-neighborhoods'
    },
    {
        id: 'robotics-1',
        ...
        caseStudyId: 'grand-street-settlement'
    },
    {
        id: 'robotics-2',
    ...
    },
    {
        ...
        grades: 'Grades 3–8',
        gradeBands: ['3–5', '6–8'],
        description: 'Students design in Tinkercad and print real objects, from keychains to prosthetic-hand challenges, scaled by age.',
        ...
        faq: [
            { question: 'How many printers do we actually need?', answer: 'One works; two is comfortable. Most printing happens between sessions from a queue, and Module 3 of the training is entirely about making that painless.' },
    ...
    },
    {
        ...
        grades: 'Grades K–8',
        gradeBands: ['K–2', '3–5', '6–8'],
        description: 'Students draw in the air with handheld 3D pens, building sculptures, structures, and wearables layer by layer. Two versions, with pens matched to each age group.',
        devices: 'None',
        materials: '3Doodler Start+ pens and PCL eco plastic (K–2), or 3Doodler Create+ / MYNT3D Pro pens and PLA filament (3–8), plus printable stencils',
        image: '/programs/3d-pen-studio.jpg',
        imageCredit: { text: 'Mrshaxas', license: 'CC BY-SA 4.0', url: 'https://commons.wikimedia.org/wiki/File:Person_using_3D_printing_pen_at_exhibition_(1).jpg' },
        tags: ['Maker', '3D Printing', 'Screen-Free', 'Take-Home Projects'],
        screenFree: true,
        versions: [
            { name: 'Little Makers', grades: 'Grades K–2', tool: '3Doodler Start+', description: 'Low temperature plastic and a nozzle that stays cool to the touch, so there are no hot parts at all. Students start by tracing stencils and work up to sculptures that stand on their own.' },
            { name: 'Studio Makers', grades: 'Grades 3–8', tool: '3Doodler Create+ or MYNT3D Pro', description: 'Hot nozzle PLA pens for freehand structures, multipart assemblies, and open design challenges. A burn safety routine is built into every session.' }
        ],
        studentOutcomes: [
            'Turn flat drawings into standing 3D objects they take home',
            'Control a 3D pen with steady speed, clean lines, and solid joins',
            'Build strong frames using triangles, layering, and cross bracing',
            'Plan a build on paper first, then assemble it from separate parts',
            'Solve a design challenge matched to their version: characters, bridges, or wearables',
            'Show their work at a family Pen Gallery'
        ],
        whyItMatters: [
            { title: 'Everyone makes at once', description: 'No print queue and no waiting on a machine. Every student has a pen in hand for the whole session, so nobody sits and watches.' },
            { title: '3D making, no screens', description: 'No computers, software, or accounts. A pen and a spool of plastic are the whole setup, so the session goes straight to building.' },
            { title: 'Something goes home every week', description: 'Pen builds are finished in the session they start. Families see new work in the backpack week after week.' },
            { title: 'Fine motor skills, disguised', description: 'Steady lines and careful joins build the hand control young students need for writing, wrapped in a project they want to finish.' }
        ],
        curriculumArc: [
            { weeks: 'Weeks 1–3', title: 'Tracing & Control', description: 'Pen safety, steady speed, and clean lines. Every student traces and peels a flat stencil shape in week 1.' },
            { weeks: 'Weeks 4–6', title: 'Going Vertical', description: 'From flat pieces to standing objects: joining panels, building upward, and making a shape hold itself up.' },
            { weeks: 'Weeks 7–10', title: 'Build It Strong', description: 'Frames, bracing, and multipart assemblies. Builds get bigger and have to survive handling.' },
            { weeks: 'Weeks 11–14', title: 'The Design Challenge', description: 'Little Makers build a character and its world. Studio Makers take on a load bearing bridge or a wearable piece.' },
            { weeks: 'Weeks 15–16', title: 'The Pen Gallery', description: 'A family exhibit where every student displays a semester of builds and demos the pen live.', isCapstone: true }
        ],
        staffOutcomes: [
            'Teach 3D pen technique from zero, no art or maker background required',
            'Run the safety routine for hot nozzle pens and know when to use cool pens instead',
            'Clear jams, swap filament, and keep a classroom set of pens working all semester',
            'Host a Pen Gallery that shows off every student\'s work'
        ],
        trainingModules: [
            { title: 'Module 1: Pen Bootcamp', description: 'Both pen models, hands on. You\'ll build your own stencil piece and a standing sculpture during training.' },
            { title: 'Module 2: Safety & Setup', description: 'Pen stations, cool down spots, and the burn safety routine for older groups.' },
            { title: 'Module 3: Pen Care', description: 'Loading, jams, and filament swaps: the five minute fixes that keep every pen in use.' },
            { title: 'Module 4: Challenge Progressions', description: 'Tracing to freehand to design challenges, and how each step scales from kindergarten to 8th grade.' },
            { title: 'Module 5: The Pen Gallery', description: 'The event playbook: display tables, live demo stations, and a room full of families.' }
        ],
        // TODO(verify): confirm these four numbers before publishing widely
        logistics: {
            sessionLength: '45–60 min',
        ...
        faq: [
            { question: 'How hot do the pens get?', answer: 'The Start+ pens used in grades K–2 have no hot parts. The nozzle stays cool to the touch. The PLA pens for grades 3–8 do get hot, so the curriculum builds a safety routine into every session and training covers it in depth.' },
            { question: 'Can we run both versions at one site?', answer: 'Yes. The curriculum arc is shared, so one trained leader can run both, and many sites do: Little Makers for younger groups and Studio Makers for older ones.' }
        ]
    },
    {
        ...
        grades: 'Grades 2–6',
        gradeBands: ['K–2', '3–5', '6–8'],
        description: 'Makey Makey turns bananas, foil, and playdough into game controllers and instruments. It teaches electricity and conductivity through pure play.',
        devices: 'Laptops',
    ...
    },
    {
        ...
        // STA mockup of a student-built detector app; source in scripts/program-mockups/ai-explorers.html
        image: '/programs/ai-explorers.jpg',
        ...
        curriculumArc: [
            ...
            { weeks: 'Weeks 15–16', title: 'The AI Fair', description: 'Families train and test models at student-run stations, where the kids are the AI experts in the room.', isCapstone: true }
        ],
        staffOutcomes: [
        ...
        faq: [
            ...
            { question: 'What happens to the photos and sounds kids record?', answer: 'Training happens on-device in the browser, so samples aren\'t uploaded to an account or stored anywhere. Close the tab and they\'re gone.' }
        ]
    },
    {
    ...
    },
    {
        ...
        whyItMatters: [
            { title: 'Coding before they can read', description: 'ScratchJr was built at MIT and Tufts for pre-readers, so every block is a picture. Kindergartners sequence real programs years before most schools introduce computer science.' },
        ...
        trainingModules: [
            ...
            { title: 'Module 5: The Story Premiere', description: 'The complete playbook for a family screening event, from projector setup to applause.' }
        ],
        // TODO(verify): confirm these four numbers before publishing widely
        logistics: {
            sessionLength: '30–45 min',
    ...
    },
    {
        ...
        whyItMatters: [
            ...
            { title: 'A showcase families show up for', description: "The Arcade Showcase turns your program's value into a public event. One site's first showcase drew 60+ families. That visibility pays off with enrollment and funders alike." },
    ...
    },
    {
        ...
        faq: [
            { question: 'Is this the same Minecraft kids play at home?', answer: 'Same core game, different edition. Minecraft Education adds coding tools and classroom controls, and multiplayer is limited to your own managed world, with no public servers.' },
    ...
    },
    {
        ...
        curriculumArc: [
            ...
            { weeks: 'Weeks 11–14', title: 'The Team World', description: 'Small teams plan and build one ambitious world together, with builder, coder, and story roles included.' },
